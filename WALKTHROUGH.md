# Master Technical Report: KLA Blind Image Restoration Challenge
...
1. **$5\times 5$ Depthwise Convolutions** (`padding=2`) in all `NAFBlock` layers, doubling spatial receptive field.
2. **$128\times 128$ Training Crop Size** ($4\times$ pixel area vs $64\times 64$), giving the network global spatial context.
3. **Charbonnier + MS-SSIM Loss Realignment**:
   $$\mathcal{L}_{\text{total}} = 0.5 \cdot \mathcal{L}_{\text{Charbonnier}} + 0.3 \cdot \mathcal{L}_{\text{MS-SSIM}} + 0.1 \cdot \mathcal{L}_{\text{Edge}} + 0.1 \cdot \mathcal{L}_{\text{Freq}}$$
...
| **Stage 3** | **+ NAFNet-UNet v2 ($5\times 5$ DW, $128^2$ Patch, MS-SSIM)** | **26.92** | **0.7206** | **0.0780** | **<8 ms** | **125+ FPS** | **0.77 M** | **2.94 MB** | **FINAL BEST** | **Major SSIM (+0.1489) and PSNR (+2.20dB) Gain!** |
...
Below are the final diagnostic training and validation curves logged during convergence training:
...
<!-- slide -->
![Advanced Evaluation 001863](C:\Users\PRIYA T\.gemini\antigravity-ide\brain\1d757fbc-87c5-44d3-adbc-341371ade8f3\advanced_eval_001863.png)
<!-- slide -->
![Advanced Evaluation 001086](C:\Users\PRIYA T\.gemini\antigravity-ide\brain\1d757fbc-87c5-44d3-adbc-341371ade8f3\advanced_eval_001086.png)
```
